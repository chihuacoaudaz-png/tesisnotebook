...
- **Cuadernos de Referencia Principales:**
  - *Tesis / Voladura / ML:* `Modernizing Blast Fragmentation: From Kuz-Ram to Machine Learning` (`335db12c-d698-4332-8608-152fa04dc79d`) y `Rock Fragmentation Prediction using the Kuz-Ram Model` (`ae93a924-19a7-44ce-838a-20c5d133610b`).
  - *Planeamiento Minero Estratégico:* `Mine Precision: Strategic Planning and Engineering for Global Mining projects` (`c797b6d5-893d-4dd5-aee1-772a9ad9466e`).
