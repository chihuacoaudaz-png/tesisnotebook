# RESUMEN Y ANÁLISIS DE DATOS OPERACIONALES: COMPAÑÍA MINERA LINCUNA S.A. 2026

## 1. Parámetros Geomecánicos y de Labor de Avance (U.E.A. Lincuna)
- **Labor:** Cruceros y Galerías de Nivel (Sección D tipo Baúl 4.5m x 4.5m, Flecha de arco = 1.25m).
- **Calidad de Macizo Rocoso:** Tipo III-B / IV-A (RMR = 55.5, GSI = 50, RQD = 60%).
- **Resistencia Compresiva Uniaxial (UCS):** 180.05 MPa.
- **Resistencia a la Tracción ($\sigma_t$):** 12.15 MPa.
- **Densidad de Roca ($ho_r$):** 2.70 TM/m³.
- **Sobrerotura Histórica Convencional:** 34.36% (Daño perimétrico por sobrecarga y mala distribución).
- **Costo Unitario de Shotcrete Vía Húmeda:** $516.58 USD/m³.
- **Meta Operacional:** Sobrerotura $\le 5.0\%$.

## 2. Inventario de Bases de Datos Operativas Disponibles en `./inputs/`:

### Archivo Operacional: `1. BD AVANCES.xlsx`
- **Hojas de Registro:** ['MAESTRO.', 'BUDGET.', 'FCST', 'PROG_SEM.', 'PROG_SEM1', 'EJECUTADO1', 'PROG_MES.', 'EJECUTADO.', 'TABLAS', 'SUSTENTO.', 'REPOR_SUST', 'ADHERENCIA', 'Hoja1', 'DIA', 'EFICIENCIAS', 'PRIORITARIA']

### Archivo Operacional: `2. BD PRODUCCION.xlsx`
- **Hojas de Registro:** ['MAESTRA', 'PROG_SEM.', 'TJ_REGULADORES', 'PROG_MES.', 'EJEC_MES', 'EXTRACCION', 'RESUMEN', 'ROTURA.', 'SUS.PROD', 'SUSTENTO.', 'BUDGET', 'REPLANTEO.MES', 'FCST4+8', 'PROG_SEM1', 'ADHERENCIA', 'EJECUTADO1', 'RESULTADO SEMANA', 'RESULTADO DIA', 'PROG_DIA', 'Hoja1']

### Archivo Operacional: `2. REPORTE DE VOLADURA  2026.xlsx`
- **Hojas de Registro:** ['MAESTRO', 'BASE DE DATOS', 'PRES. JUEVES', 'FACTOR CARGA LINEAL', 'FACTOR POTENCIA', 'CALENDARIO']

### Archivo Operacional: `3. BD TL JUMBOS 2026.xlsx`
- **Hojas de Registro:** ['TABLAS', 'HORAS', 'FILAS', 'JUMBOS', "KPI's LUNES", 'PARETO', 'THECMIN', 'HOROMETRO']

### Archivo Operacional: `4. BD JUMBOS (EMP-FRONT) 2026.xlsx`
- **Hojas de Registro:** ['NO BORRAR', 'HORAS', 'TABLAS', 'HOROMETRO', 'JUMBOS', 'Hoja5', 'Hoja2', 'DASHBOARD', 'PARETO-JU', "KPI's LUNES", 'Hoja1', 'INICIO_PERF', 'HORA DE PARADAS', 'ATAQUE OPERATIVO', 'DM-UT SOLICITADO', 'DETALL', 'T.UNICAS', 'MAESTRO', '46']

### Archivo Operacional: `5. BD-SCOOP 2026.xlsx`
- **Hojas de Registro:** ['TABLAS', 'HORA', "KPI's LUNES", 'SCOOP', 'HOROMETROS', 'RELLENO']

### Archivo Operacional: `5.1. BD-DUMPER.xlsx`
- **Hojas de Registro:** ['HORAS', 'REPARTO DE GUARDIA', "KPI's LUNES", 'DP02', 'DUMPER', 'NO BORRAR', 'TABLAS', 'Detalle1', 'Hoja4', 'ZONA DE EQUIPOS', 'Hoja2']

### Archivo Operacional: `6. BD SOSTENIMIENTO METALICO.xlsx`
- **Hojas de Registro:** ['MEDICION', 'MAESTRO', 'RESUMEN', 'BASE SOSTENIMIENTO', 'CALENDARIO', 'BASE SHOTCRETE', 'BUDGET-PROGRAMA']

### Archivo Operacional: `7. HOROMETROS_EQUIPOS.xlsx`
- **Hojas de Registro:** ['HOROMETRO-SCOOP', 'HOROMETRO-EMP-FRONT', 'HOROMETRO-TL', 'HOROMETRO-SCOOP (2)', 'HOROMETRO-EMP-FRONT (2)', 'HOROMETRO-TL (2)', 'HOR-TL', 'HOR-EMP-FRONT', 'HOR-SCOOP']

### Archivo Operacional: `8. BD CAMIONES.xlsx`
- **Hojas de Registro:** ['HORAS', 'CAMIONES', "KPI's", 'PRIMER TRASLADO', 'TABLAS', 'PARETO']
