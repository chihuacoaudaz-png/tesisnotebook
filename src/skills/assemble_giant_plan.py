# -*- coding: utf-8 -*-
"""
ENSAMBLADOR MAESTRO GIGANTE (PRODUCE >= 32 PÁGINAS FÍSICAS EN MICROSOFT WORD Y PDF)
"""
...
def assemble_giant_plan(output_docx="output/PLAN_DE_TESIS_MARCO_TEORICO_30PAGS.docx"):
