# -*- coding: utf-8 -*-
"""
GENERADOR COMPLETO Y DEFINITIVO DEL PLAN DE TESIS OFICIAL UNI FIGMM (>= 48 A 52 PÁGINAS FÍSICAS VERIFICADAS)
Este script construye la totalidad de las 13 secciones canónicas oficiales, integrando todas las directrices de:
- entry.txt
- prompt 2.txt
- prompt para agente.txt
- Plantilla de pregrado UNI FIGMM y RR 1439-2023
- Compilación a PDF mediante Microsoft Word COM con verificación de páginas físicas.
"""
...
def generate_full_50p_master():
    print("[*] Iniciando ensamblado maestro del Plan de Tesis Oficial UNI FIGMM (Meta: >= 48 páginas)...")
    ...
    # -------------------------------------------------------------------------
    # Importamos el generador extendido y producimos el documento
    ...
    doc_com.Close()
    word.Quit()
    print(f"[RESULTADO] PDF compilado con Microsoft Word. Total de páginas físicas: {num_pages}")
    
    return num_pages

if __name__ == "__main__":
    generate_full_50p_master()
