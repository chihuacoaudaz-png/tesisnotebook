# -*- coding: utf-8 -*-
"""
COMPILADOR MAESTRO DE TESIS OFICIAL UNI FIGMM (50+ PÁGINAS CONTINUAS Y DENSAS)
Escuela Profesional de Ingeniería de Minas - Universidad Nacional de Ingeniería
Sin saltos de página artificiales, con prosa académica continua, derivaciones matemáticas completas,
tablas de campo de Lincuna, contrastes estadísticos inferenciales y análisis de precios unitarios auditados.
"""
...
def generate_continuous_thesis_pdf(pdf_filename="output/TESIS_OFICIAL_UNI_LINCUNA_50PAGS.pdf"):
    os.makedirs(os.path.dirname(pdf_filename), exist_ok=True)
    
    # Márgenes oficiales UNI FIGMM: Izquierdo 3.5 cm (encuadernación), Derecho 2.5 cm, Superior 2.5 cm, Inferior 2.5 cm
    ...
    # Paleta de colores institucionales UNI FIGMM
    c_primary = colors.HexColor("#0D233A")    # Azul Marino Institucional UNI
    c_secondary = colors.HexColor("#1B4F72")  # Azul Medio Técnico
    c_dark = colors.HexColor("#2C3E50")       # Texto Principal Carbono
    c_muted = colors.HexColor("#566573")      # Gris Técnico
    c_bg_light = colors.HexColor("#F8F9FA")   # Fondo Alterno Tablas
    c_border = colors.HexColor("#CBD5E0")     # Bordes de Tablas
    
    # Estilos tipográficos calibrados para densidad continua sin espacios artificiales
    ...
    style_h1 = ParagraphStyle('Heading1_Continuous', fontName='Helvetica-Bold', fontSize=11, leading=14, textColor=c_primary, spaceBefore=12, spaceAfter=5, keepWithNext=True)
    style_h2 = ParagraphStyle('Heading2_Continuous', fontName='Helvetica-Bold', fontSize=9.5, leading=12.5, textColor=c_secondary, spaceBefore=9, spaceAfter=4, keepWithNext=True)
    style_h3 = ParagraphStyle('Heading3_Continuous', fontName='Helvetica-Bold', fontSize=8.5, leading=11.5, textColor=c_dark, spaceBefore=7, spaceAfter=3, keepWithNext=True)
    style_body = ParagraphStyle('Body_Continuous', fontName='Helvetica', fontSize=8, leading=11.2, alignment=4, textColor=c_dark, spaceAfter=4.5)
    style_bullet = ParagraphStyle('Bullet_Continuous', fontName='Helvetica', fontSize=8, leading=11, alignment=4, leftIndent=10, textColor=c_dark, spaceAfter=3)
    style_eq = ParagraphStyle('Equation_Continuous', fontName='Helvetica-Bold', fontSize=7.5, leading=10, alignment=1, textColor=c_primary, spaceBefore=3.5, spaceAfter=4.5)
    style_caption = ParagraphStyle('Caption_Continuous', fontName='Helvetica-Oblique', fontSize=7, leading=9, alignment=1, textColor=c_muted, spaceBefore=2.5, spaceAfter=5)
    style_th = ParagraphStyle('TableHeader_Continuous', fontName='Helvetica-Bold', fontSize=6.8, leading=8.5, alignment=1, textColor=colors.white)
    style_td = ParagraphStyle('TableCell_Continuous', fontName='Helvetica', fontSize=6.5, leading=8, textColor=c_dark)
    style_code = ParagraphStyle('Code_Continuous', fontName='Courier', fontSize=6, leading=7.5, textColor=c_primary)
    ...
    story.append(p("<i>A mis respetados padres, por constituir el pilar fundamental de mi formación moral, intelectual y humana, por su sacrificio constante y por inculcarme el valor inquebrantable de la perseverancia frente a la adversidad.</i>"))
    story.append(p("<i>A mis hermanos y seres queridos, por su constante aliento y comprensión durante las prolongadas jornadas de estudio e investigación en mina.</i>"))
    ...
    story.append(HRFlowable(width="100%", thickness=1, color=c_primary, spaceAfter=8))
    story.append(p("A la <b>Universidad Nacional de Ingeniería (UNI)</b>, alma máter de la ingeniería peruana, por brindarme una rigurosa formación académica, científica y deontológica de estándar internacional en sus aulas y laboratorios."))
    ...
    toc_data = [
        ...
        ("   1.2. Planteamiento de la Realidad Problemática de Sobrerotura en Avances", "4"),
        ("   1.3. Mecanismos Físicos y Geomecánicos de la Sobre-excavación", "6"),
        ("   1.4. Modelo de Sobrecostos en el Ciclo Minero y Partida de Sostenimiento", "7"),
        ("   1.5. Árbol de Causas Raíz, Problema Central y Efectos Críticos", "9"),
        ("   1.6. Cuadro Comparativo de Situación Actual vs. Situación con Sistema Agéntico", "10"),
        ("   1.7. Formulación del Problema (General y Específicos)", "11"),
        ("   1.8. Justificación Cuádruple de la Investigación", "12"),
        ("   1.9. Delimitación y Alcances del Estudio", "13"),
        ("   1.10. Objetivos de la Investigación (General y Específicos)", "14"),
        ("   1.11. Hipótesis de la Investigación (General y Específicas)", "15"),
        ("   1.12. Matriz de Operacionalización de Variables", "16"),
        ("CAPÍTULO II: MARCO TEÓRICO Y CONCEPTUAL", "18"),
        ("   2.1. Antecedentes Internacionales de la Investigación", "18"),
        ("   2.2. Antecedentes Nacionales (Poderosa, Horizonte, San Rafael, Chungar)", "20"),
        ("   2.3. Antecedentes Locales y Cátedras de Titulación UNI FIGMM", "22"),
        ("   2.4. Matriz Comparativa de Antecedentes y Brecha Científica", "23"),
        ("   2.5. Geomecánica del Macizo Rocoso (RMR 89, GSI, Hoek-Brown 2018)", "24"),
        ("   2.6. Termodinámica de la Detonación y Ecuación de Chapman-Jouguet", "26"),
        ("   2.7. Formulación de la Ecuación de Estado JWL para Emulsiones", "28"),
        ("   2.8. Mecánica de Fracturamiento Dinámico y Teoría de Voladura Controlada", "30"),
        ("   2.9. Deducción Matemática Integral del Modelo de Holmberg-Persson (5 Secciones)", "32"),
        ("   2.10. Algoritmo Heurístico de Auto-Tajeo Espacial en Sección Baúl", "36"),
        ("   2.11. Inteligencia Artificial Agéntica Determinística y Protocolo MCP", "38"),
        ("   2.12. Marco Conceptual Extenso (Glosario Enciclopédico Especializado)", "40"),
        ("CAPÍTULO III: METODOLOGÍA Y DESARROLLO DEL TRABAJO", "43"),
        ("   3.1. Enfoque Cuantitativo, Tipo Aplicada y Nivel Explicativo", "43"),
        ("   3.2. Diseño Cuasiexperimental Longitudinal Pre-Test / Post-Test", "44"),
        ("   3.3. Unidad de Análisis, Población y Muestra Probabilística", "45"),
        ("   3.4. Caracterización Petrográfica y Propiedades Físico-Mecánicas de Laboratorio", "46"),
        ("   3.5. Instrumentación Geométrica con Escáner Láser 3D LIDAR y Nubes de Puntos", "47"),
        ("   3.6. Protocolo Operativo Estándar (POE) de Perforación y Voladura", "49"),
        ("   3.7. Protocolo Estadístico Inferencial (Pruebas t-Student paramétricas)", "50"),
        ("CAPÍTULO IV: ANÁLISIS E INTERPRETACIÓN DE RESULTADOS", "52"),
        ("   4.1. Resultados del Dimensionamiento de Malla Asistida por IA (47 taladros)", "52"),
        ("   4.2. Análisis de Presiones Dinámicas y Verificación de Seguridad Pte <= UCS", "54"),
        ("   4.3. Evaluación Geométrica de Sobrerotura con Escaneo Láser 3D", "55"),
        ("   4.4. Resultados del Contraste de Hipótesis Inferenciales (`SKILL-04`)", "57"),
        ("   4.5. Análisis de Varianza (ANOVA) y Verificación de Supuestos de Normalidad", "58"),
        ("   4.6. Evaluación Económica y Ahorro Comprobado en Sostenimiento con Shotcrete", "60"),
        ("   4.7. Análisis de Sensibilidad Paramétrica frente a Variaciones de RMR", "62"),
        ("   4.8. Discusión de Resultados y Contrastación con la Literatura", "63"),
        ("CAPÍTULO V: CONCLUSIONES Y RECOMENDACIONES", "65"),
        ("   5.1. Conclusiones de la Investigación", "65"),
        ("   5.2. Recomendaciones Operacionales y Tecnológicas", "67"),
        ("ASPECTOS ADMINISTRATIVOS: CRONOGRAMA Y PRESUPUESTO", "68"),
        ("REFERENCIAS BIBLIOGRÁFICAS (NORMA APA 7MA EDICIÓN — 50+ FUENTES)", "70"),
        ("ANEXO 1: MATRIZ DE CONSISTENCIA CIENTÍFICA (CORRESPONDENCIA 1:1)", "74"),
        ("ANEXO 2: REGISTRO EXPERIMENTAL DE LOS 30 DISPAROS DE CAMPO", "76"),
        ("ANEXO 3: CÓDIGO FUENTE EN PYTHON DEL MOTOR DETERMINÍSTICO", "78"),
        ("ANEXO 4: PLANO Y COORDENADAS (X,Y) DE LA MALLA DIMENSIONADA", "81"),
        ("ANEXO 5: FICHAS TÉCNICAS GEOMECÁNICAS DE LOS 5 CRUCEROS", "83"),
        ("ANEXO 6: ANÁLISIS DE PRECIOS UNITARIOS AUDITADOS (APU) DE SHOTCRETE", "85"),
    ]
    t_toc_data = []
    ...
    # ==========================================
    # 2. CUERPO CONTINUO DE LA TESIS (50+ PÁGS)
    # ==========================================
...
"""
    ...
    print(f"[EXITO] Tesis Continua y Densa compilada en: {pdf_filename}")

if __name__ == "__main__":
    generate_continuous_thesis_pdf()
