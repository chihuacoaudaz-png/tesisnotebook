# -*- coding: utf-8 -*-
"""
GENERADOR DEFINITIVO MAESTRO DEL PLAN DE TESIS UNI FIGMM (48-52 PÁGINAS FÍSICAS)
Integra:
1. Lógica humana del investigador (entry.txt, prompt 2.txt, prompt para agente.txt)
2. Estructura canónica oficial del PLAN DE TESIS UNI FIGMM (plantilla pregrado y RR 1439-2023)
3. Fórmulas matemáticas formateadas limpiamente sin errores de renderizado
4. Generación de Markdown (.md), LaTeX (.tex), Word (.docx) y PDF (.pdf)
"""
...
def generate_and_verify_master_plan():
    print("[*] Iniciando construcción del Plan de Tesis Maestro UNI FIGMM (>= 45 páginas)...")
    ...
    def add_formula(eq_text, where_items=None):
        # Renderizado limpio para fórmulas matemáticas (fondo gris tenue, centrado, variables claras)
        p = doc.add_paragraph()
        p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    ...
    # Importamos y ensamblamos todo el texto expandido
    from generate_massive_full_plan_35p import generate_massive_plan_docx
    # Ejecutamos la lógica que garantiza el contenido completo
