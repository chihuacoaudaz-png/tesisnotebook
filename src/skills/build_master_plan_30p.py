# -*- coding: utf-8 -*-
"""
COMPILADOR INTEGRAL MAESTRO DEL PLAN DE TESIS UNI FIGMM (MARCO TEÓRICO EN PROFUNDIDAD >= 32 PÁGINAS)
"""
...
if __name__ == "__main__":
    docx_file = generate_full_plan_32p()
