# -*- coding: utf-8 -*-
"""
GENERADOR COMPLETO Y EXHAUSTIVO DEL PLAN DE TESIS UNI FIGMM
Produce un documento de >= 32 a 36 páginas físicas en Microsoft Word y PDF.
"""
...
def create_massive_plan_doc(output_docx="output/PLAN_DE_TESIS_MARCO_TEORICO_30PAGS.docx"):
    ...
    add_body("La fundamentación del presente plan se sustenta en una revisión crítica de investigaciones científicas y tesis universitarias contemporáneas, publicadas estrictamente entre los años 2020 y 2026, clasificadas en tres niveles geográficos y académicos:")
    ...
    add_body("El yacimiento minero polimetálico de la U.E.A. Lincuna se emplaza en el flanco oriental de la Cordillera Negra, dentro del cinturón metalogenético Cenozoico de pórfidos y depósitos epitermales polimetálicos (Zn-Pb-Ag-Cu) de la zona central del Perú, a cotas altimétricas comprendidas entre los 4,200 y 4,650 msnm, en el distrito de Ticapampa, provincia de Recuay, departamento de Áncash.")
    ...
    add_body("En el ámbito específico de las labores subterráneas en estudio (Cruceros 100, 120, 140, 160 y 180 en los Niveles 4, 6, 8, 10 y 12), las excavaciones se desarrollan en las facies lávicas intermedias del Grupo Calipuy, caracterizadas por andesitas porfiríticas competentes y dacitas compactas de color gris verdoso a violáceo, con esporádicos horizontes de tobas piroclásticas compactadas.")
...
if __name__ == "__main__":
    docx_file = create_massive_plan_doc()
