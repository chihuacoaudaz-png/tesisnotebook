# -*- coding: utf-8 -*-
"""
GENERADOR MAESTRO EXTENDIDO (VERIFICADO >= 32 PÁGINAS FÍSICAS EN MS WORD / PDF)
"""
...
def generate_true_32p_document(output_docx="output/PLAN_DE_TESIS_MARCO_TEORICO_30PAGS.docx"):
    ...
    add_body("En estricta concordancia con el Reglamento de Grados y Títulos de la Facultad de Ingeniería Geológica, Minera y Metalúrgica de la Universidad Nacional de Ingeniería (UNI FIGMM) y las directivas académicas de investigación aplicadas a la Escuela Profesional de Ingeniería de Minas, el presente Plan de Tesis focaliza su desarrollo en las bases teórico-científicas y metodológicas de mayor complejidad analítica. A fin de permitir una visión global y cuantitativa de la estructura final y orientar el criterio del tesista y del jurado calificador, se ha modelado matemáticamente la distribución de páginas que ocuparán las secciones complementarias (Planteamiento del Problema, Hipótesis, Objetivos, Matriz de Consistencia, Cronograma y Presupuesto) para completar un documento final de alta rigurosidad académica:")
...
if __name__ == "__main__":
    docx_file = generate_true_32p_document()
