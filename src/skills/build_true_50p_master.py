# -*- coding: utf-8 -*-
"""
GENERADOR COMPLETO Y EXTENSO DEL PLAN DE TESIS UNI FIGMM (48-52 PÁGINAS FÍSICAS VERIFICADAS)
"""
...
def generate_true_50p_plan():
    print("[*] Iniciando generación del Plan de Tesis Maestro UNI FIGMM (Objetivo: 48-52 páginas físicas)...")
    ...
    # Configuración de márgenes institucionales UNI FIGMM (3.0 cm izq, 2.54 cm sup, 2.5 cm der/inf)
    ...
    # Ejecutar la generación completa verificada
    ...
    doc_com.Close()
    word.Quit()
    print(f"[RESULTADO FINAL] PDF compilado con Microsoft Word. Total de páginas físicas: {num_pages}")
    
    return num_pages

if __name__ == "__main__":
    generate_true_50p_plan()
