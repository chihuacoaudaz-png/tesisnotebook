...
def build_pdf():
    filename = "output/TESIS_OFICIAL_UNI_LINCUNA_50PAGS.pdf"
    ...
    toc_p2 = [
        ...
        ("   2.9. Inteligencia Artificial Agéntica Determinística y Protocolo MCP", "46"),
        ("   2.10. Marco Conceptual Extenso (Glosario Enciclopédico Especializado)", "48"),
        ("CAPÍTULO III: METODOLOGÍA Y DESARROLLO DEL TRABAJO", "53"),
        ("   3.1. Enfoque Cuantitativo, Tipo Aplicada y Diseño Cuasiexperimental", "53"),
        ("   3.2. Unidad de Análisis y Caracterización Geomecánica In Situ", "54"),
        ("   3.3. Matriz de Operacionalización de Variables (X, Y, Z)", "55"),
        ("   3.4. Población, Muestra Probabilística y Criterios de Selección", "57"),
        ("   3.5. Técnicas e Instrumentos de Medición (LIDAR 3D y Nubes de Puntos)", "58"),
        ("   3.6. Protocolo Operativo Estándar (POE) de Perforación y Voladura", "60"),
        ("   3.7. Protocolo Estadístico Inferencial (Pruebas t-Student paramétricas)", "62"),
        ("CAPÍTULO IV: ANÁLISIS E INTERPRETACIÓN DE RESULTADOS", "64"),
        ("   4.1. Resultados del Dimensionamiento de la Malla (47 tal., 1.622 kg/m³)", "64"),
        ("   4.2. Análisis de Presiones Dinámicas y Verificación de Seguridad Pte <= UCS", "66"),
        ("   4.3. Evaluación Geométrica de Sobrerotura con Escaneo Láser 3D", "68"),
        ("   4.4. Evaluación Económica y Ahorro Comprobado en Sostenimiento", "70"),
        ("   4.5. Resultados del Contraste de Hipótesis Inferenciales (`SKILL-04`)", "72"),
        ("   4.6. Análisis de Sensibilidad Paramétrica frente a Variaciones de RMR", "74"),
        ("   4.7. Discusión de Resultados y Contrastación con la Literatura", "76"),
        ("CAPÍTULO V: CONCLUSIONES Y RECOMENDACIONES", "78"),
        ("   5.1. Conclusiones de la Investigación", "78"),
        ("   5.2. Recomendaciones Operacionales y Tecnológicas", "80"),
        ...
        ("ANEXO 2: REGISTRO INDIVIDUAL DE LAS 30 VOLADURAS DE CAMPO", "89"),
        ("ANEXO 3: CÓDIGO FUENTE EN PYTHON DEL SISTEMA AGÉNTICO", "92"),
        ("ANEXO 4: PLANO Y COORDENADAS (X,Y) DE LA MALLA DIMENSIONADA", "96"),
    ]
    t_toc2_data = []
