...
def generate_full_plan_50p_master():
    print("[*] Generando Plan de Tesis Oficial UNI FIGMM (48-52 páginas físicas)...")
    ...
    # -------------------------------------------------------------------------
    # EJECUTAR LA CONSTRUCCIÓN VERIFICADA EXTENDIDA
    # -------------------------------------------------------------------------
