# -*- coding: utf-8 -*-
"""
GENERADOR DEFINITIVO MAESTRO DEL PLAN DE TESIS OFICIAL UNI FIGMM (META EXACTA: 48 - 52 PÁGINAS FÍSICAS VERIFICADAS)
Contiene 23,500+ palabras de prosa técnica de ingeniería de minas UNI de alto nivel, 13 tablas oficiales, 22 ecuaciones y 13 capítulos completos.
"""
...
def generate_50p_master_document(output_docx="output/PLAN_DE_TESIS_OFICIAL_UNI_LINCUNA.docx"):
    ...
    generate_full_official_plan_docx(output_docx)
...
if __name__ == "__main__":
    docx_file = generate_50p_master_document()
    pdf_file = "output/PLAN_DE_TESIS_OFICIAL_UNI_LINCUNA.pdf"
