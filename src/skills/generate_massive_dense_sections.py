# -*- coding: utf-8 -*-
"""
GENERADOR EXPANDIDO Y ULTRA RIGUROSO DE CONTENIDO ACADÉMICO PARA TESIS UNI FIGMM (52-55 PÁGS)
Prosa continua de alta densidad técnica, análisis geomecánico de mina Lincuna,
fórmulas hidrodinámicas ZND/C-J/JWL, deducciones matemáticas de Holmberg en las 5 secciones,
algoritmos agénticos MCP, estadística inferencial completa (t-Student, ANOVA, Shapiro-Wilk)
y auditoría económica de shotcrete a $285 USD/m³.
"""
...
def append_massive_dense_thesis_content(story, ph1, ph2, ph3, p, pb, peq, pcap, style_th, style_td, style_code, c_primary, c_border, c_bg_light):
    ...
    toc_data = [
        ...
        ("   1.2. Marco Geológico Estructural y Campo de Esfuerzos In Situ", "6"),
        ("   1.3. Planteamiento de la Realidad Problemática de Sobrerotura en Avances", "8"),
        ("   1.4. Mecanismos Físicos y Geomecánicos de la Sobre-excavación", "10"),
        ("   1.5. Modelo de Sobrecostos en el Ciclo Minero y Partida de Sostenimiento", "12"),
        ("   1.6. Árbol de Causas Raíz, Problema Central y Efectos Críticos", "14"),
        ("   1.7. Cuadro Comparativo de Situación Actual vs. Situación con Sistema Agéntico", "15"),
        ("   1.8. Formulación del Problema (General y Específicos)", "17"),
        ("   1.9. Justificación Cuádruple de la Investigación", "18"),
        ("   1.10. Delimitación y Alcances del Estudio", "20"),
        ("   1.11. Objetivos de la Investigación (General y Específicos)", "21"),
        ("   1.12. Hipótesis de la Investigación (General y Específicas)", "22"),
        ("   1.13. Matriz de Operacionalización de Variables", "23"),
        ("CAPÍTULO II: MARCO TEÓRICO Y CONCEPTUAL", "25"),
        ("   2.1. Antecedentes Internacionales de la Investigación", "25"),
        ("   2.2. Antecedentes Nacionales (Poderosa, Horizonte, San Rafael, Chungar)", "27"),
        ("   2.3. Antecedentes Locales y Cátedras de Titulación UNI FIGMM", "29"),
        ("   2.4. Matriz Comparativa de Antecedentes y Brecha Científica", "30"),
        ("   2.5. Geomecánica del Macizo Rocoso (RMR 89, GSI, Hoek-Brown 2018)", "31"),
        ("   2.6. Termodinámica de la Detonación, Modelo ZND y Ecuación de Chapman-Jouguet", "34"),
        ("   2.7. Formulación de la Ecuación de Estado JWL para Emulsiones Encartuchadas", "36"),
        ("   2.8. Mecánica de Fracturamiento Dinámico y Teoría de Voladura Controlada", "38"),
        ("   2.9. Deducción Matemática Integral del Modelo de Holmberg-Persson (5 Secciones)", "40"),
        ("   2.10. Algoritmo Heurístico de Auto-Tajeo Espacial en Sección Baúl", "44"),
        ("   2.11. Inteligencia Artificial Agéntica Determinística y Protocolo MCP", "46"),
        ("   2.12. Marco Conceptual Extenso (Glosario Enciclopédico Especializado)", "48"),
        ("CAPÍTULO III: METODOLOGÍA Y DESARROLLO DEL TRABAJO", "51"),
        ("   3.1. Enfoque Cuantitativo, Tipo Aplicada y Nivel Explicativo", "51"),
        ("   3.2. Diseño Cuasiexperimental Longitudinal Pre-Test / Post-Test", "52"),
        ("   3.3. Unidad de Análisis, Población y Muestra Probabilística", "53"),
        ("   3.4. Caracterización Petrográfica y Propiedades Físico-Mecánicas de Laboratorio", "54"),
        ("   3.5. Instrumentación Geométrica con Escáner Láser 3D LIDAR y Nubes de Puntos", "56"),
        ("   3.6. Protocolo Operativo Estándar (POE) de Perforación y Voladura", "58"),
        ("   3.7. Protocolo Estadístico Inferencial (Pruebas t-Student paramétricas)", "59"),
        ("CAPÍTULO IV: ANÁLISIS E INTERPRETACIÓN DE RESULTADOS", "61"),
        ("   4.1. Resultados del Dimensionamiento de Malla Asistida por IA (47 taladros)", "61"),
        ("   4.2. Análisis de Presiones Dinámicas y Verificación de Seguridad Pte <= UCS", "63"),
        ("   4.3. Evaluación Geométrica de Sobrerotura con Escaneo Láser 3D", "65"),
        ("   4.4. Resultados del Contraste de Hipótesis Inferenciales (`SKILL-04`)", "67"),
        ("   4.5. Análisis de Varianza (ANOVA) y Verificación de Supuestos de Normalidad", "69"),
        ("   4.6. Evaluación Granulométrica de Fragmentación (Split-Desktop)", "71"),
        ("   4.7. Evaluación Económica y Ahorro Comprobado en Sostenimiento con Shotcrete", "72"),
        ("   4.8. Análisis de Sensibilidad Paramétrica frente a Variaciones de RMR", "74"),
        ("   4.9. Discusión de Resultados y Contrastación con la Literatura", "75"),
        ("CAPÍTULO V: CONCLUSIONES Y RECOMENDACIONES", "77"),
        ("   5.1. Conclusiones de la Investigación", "77"),
        ("   5.2. Recomendaciones Operacionales y Tecnológicas", "79"),
        ("ASPECTOS ADMINISTRATIVOS: CRONOGRAMA Y PRESUPUESTO", "81"),
        ("REFERENCIAS BIBLIOGRÁFICAS (NORMA APA 7MA EDICIÓN — 50+ FUENTES)", "83"),
        ("ANEXO 1: MATRIZ DE CONSISTENCIA CIENTÍFICA (CORRESPONDENCIA 1:1)", "87"),
        ("ANEXO 2: REGISTRO EXPERIMENTAL DE LOS 30 DISPAROS DE CAMPO", "89"),
        ("ANEXO 3: CÓDIGO FUENTE EN PYTHON DEL MOTOR DETERMINÍSTICO", "91"),
        ("ANEXO 4: PLANO Y COORDENADAS (X,Y) DE LA MALLA DIMENSIONADA", "94"),
        ("ANEXO 5: FICHAS TÉCNICAS GEOMECÁNICAS DE LOS 5 CRUCEROS", "96"),
        ("ANEXO 6: ANÁLISIS DE PRECIOS UNITARIOS AUDITADOS (APU) DE SHOTCRETE", "98"),
    ]
    t_toc_data = []
    ...
    tables_toc = [
        ("Tabla 1.1: Matriz de Correlación de Esfuerzos In Situ y Resistencia Compresiva", "7"),
        ("Tabla 1.2: Cuadro Comparativo Situación Histórica vs. Situación con Sistema Agéntico", "16"),
        ("Tabla 1.3: Matriz de Operacionalización de Variables de la Investigación", "23"),
        ("Tabla 2.1: Matriz Comparativa de Antecedentes Internacionales, Nacionales y Locales", "30"),
        ("Tabla 2.2: Clasificación Geomecánica RMR (Bieniawski, 1989) en Frentes de Lincuna", "32"),
        ("Tabla 2.3: Parámetros del Criterio Generalizado de Hoek-Brown (2018)", "33"),
        ("Tabla 2.4: Propiedades Termodinámicas y Coeficientes JWL de Emulsiones Encartuchadas", "37"),
        ("Tabla 2.5: Resumen de Parámetros de Diseño de la Malla de Holmberg-Persson", "43"),
        ("Tabla 3.1: Ensayos Físico-Mecánicos Normalizados de Laboratorio UNI FIGMM", "55"),
        ("Tabla 4.1: Resumen Técnico Cuantitativo de la Malla Optimizada de 47 Taladros", "62"),
        ("Tabla 4.2: Contrastación Estadística Inferencial (Pruebas t-Student y Tamaño del Efecto)", "68"),
        ("Tabla 4.3: Análisis de Varianza (ANOVA) y Pruebas de Normalidad de Shapiro-Wilk", "70"),
        ("Tabla 4.4: Distribución Granulométrica Split-Desktop y Fragmentación P80", "71"),
        ("Tabla 4.5: Balance Económico Comparativo y Ahorro en Sostenimiento con Shotcrete", "73"),
        ("Tabla 4.6: Cronograma de Actividades WBS (Diagrama de Gantt de 16 Semanas)", "81"),
        ("Tabla 4.7: Presupuesto Analítico Consolidado del Proyecto de Titulación", "82"),
        ("Tabla A1: Matriz de Consistencia Científica Biunívoca 1:1", "87"),
        ("Tabla A2: Registro Individual Experimental de los 30 Disparos Instrumentados", "89"),
        ("Tabla A4: Reporte de Coordenadas Geométricas (x, y) de los 47 Taladros", "94"),
        ("Tabla A5: Fichas Técnicas Geomecánicas de los Cruceros 100, 120, 140, 160 y 180", "96"),
        ("Tabla A6: Análisis de Precios Unitarios (APU) Auditado de Shotcrete Vía Húmeda", "98"),
    ]
    t_tab_data = []
    ...
    fig_toc = [
        ...
        ("Figura 1.2: Tensor de Esfuerzos Principales In Situ y Orientación de Discontinuidades", "7"),
        ("Figura 1.3: Nube de Puntos 3D LIDAR: Sección Teórica vs. Cavidad Real Sobre-excavada", "9"),
        ("Figura 1.4: Mecanismos de Propagación de Ondas P, Spalling por Tracción y Presurización", "11"),
        ("Figura 1.5: Gráfico de Cascada de Sobrecostos en Sostenimiento y Ciclo de Carguío", "13"),
        ("Figura 2.1: Envolventes de Resistencia de Hoek-Brown (2018) para Macizo Tipo III-B", "33"),
        ("Figura 2.2: Curva de Expansión Isentrópica JWL: Presión vs. Volumen Relativo de Gas", "37"),
        ("Figura 2.3: Esquema de Coalescencia de Grietas de Tracción entre Barrenos de Contorno", "39"),
        ("Figura 2.4: Plano Geométrico de la Malla de 47 Taladros en Sección Baúl 4.50m x 4.50m", "44"),
        ("Figura 2.5: Arquitectura Multi-Agente Autónoma y Bucle Cerrado de Calidad con Red Team", "47"),
        ("Figura 3.1: Curvas Esfuerzo-Deformación y Fotografías de Testigos Ensayados en Laboratorio", "55"),
        ("Figura 3.2: Registro de Nube de Puntos 3D en CloudCompare con Mapa de Desviaciones", "57"),
        ("Figura 4.1: Comparación del Índice de Sobrerotura en 30 Disparos (Línea Base vs. Post-Test)", "66"),
        ("Figura 4.2: Curvas Granulométricas Acumuladas P80 en Frentes Volados con el Sistema", "71"),
        ("Figura 4.3: Gráfico de Distribución del Ahorro Económico Auditado en Sostenimiento", "73"),
    ]
    t_fig_data = []
    ...
    story.append(ph2("1.2. Marco Geológico Estructural y Campo de Esfuerzos In Situ"))
    story.append(p("El marco estructural de la U.E.A. Lincuna está gobernado por el sistema de fallas longitudinales del Callejón de Huaylas de orientación NO-SE, conjugadas con sistemas de cizalla transversal E-O. Estas fallas regionales delimitan bloques hidrotermales con grados variables de alteración fílica (cuarzo-sericita-pirita) y propilítica (clorita-epidota-calcita). La presencia de estas alteraciones reduce la cohesión en los planos de discontinuidad y genera planos de debilidad preferenciales que canalizan la energía destructiva de la voladura."))
    story.append(p("El estado de esfuerzos in situ a una profundidad media de cobertura de $H = 450\text{ m}$ se calculó a partir de la densidad media suprayacente ($\rho_r = 2.70\text{ TM/m}^3 = 0.0265\text{ MN/m}^3$):"))
    story.append(peq("$$\\sigma_v = \\gamma \\cdot H = 0.0265 \\times 450 = \\mathbf{11.93\\text{ MPa}}$$"))
    story.append(p("Aplicando la formulación elástica de Sheorey (1994) para la relación de esfuerzos horizontales a verticales ($k$) en función del módulo de Young intacto ($E_i = 42.50\text{ GPa}$) y la profundidad:"))
    story.append(peq("$$k = 0.25 + 7 E_i \\left(0.001 + \\frac{1}{H}\\right) = 0.25 + 7(42.50) \\left(0.001 + \\frac{1}{450}\\right) = \\mathbf{1.208}$$"))
    story.append(peq("$$\\sigma_h = k \\cdot \\sigma_v = 1.208 \\times 11.93 = \\mathbf{14.41\\text{ MPa}}$$"))
    story.append(p("Este campo tensional anisotrópico ($\sigma_h > \sigma_v$) induce una concentración de esfuerzos tangenciales en la clave y hastiales de la sección baúl. Si la voladura genera microfisuración inducida en el perímetro, la redistribución de estos esfuerzos provoca la caída de cuñas y la desarticulación de bloques rocosos."))
    story.append(pcap("[Poner imagen de: Tensor de Esfuerzos Principales In Situ y Orientación Espacial de Discontinuidades en Cruceros]"))
    story.append(Spacer(1, 0.15 * cm))

    story.append(ph2("1.3. Planteamiento de la Realidad Problemática de Sobrerotura en Avances"))
    ...
    story.append(ph2("1.4. Mecanismos Físicos y Geomecánicos de la Sobre-excavación"))
    ...
    story.append(ph2("1.5. Modelo de Sobrecostos en el Ciclo Minero y Partida de Sostenimiento"))
    ...
    story.append(ph2("1.6. Árbol de Causas Raíz, Problema Central y Efectos Críticos"))
    ...
    story.append(pb("<b>Causas Raíz:</b> (1) Ausencia de un sistema de diseño inteligente adaptativo al RMR; (2) Inexistencia de voladura controlada desacoplada en el contorno; (3) Inadecuada distribución geométrica de cargas en el área de tajeo; (4) Descalibración de factores de fijación en arrastres."))
    story.append(pb("<b>Causas Directas:</b> Presiones de detonación en contorno superiores a 500 MPa; arranque empírico hiper-confinado; falta de paralelismo en barrenos perimétricos; ausencia de taladro de alivio escariado de gran diámetro."))
    ...
    story.append(pb("<b>Efectos Directos:</b> Sobre-excavación de 22.75 m³ de roca rota por disparo; consumo excesivo de shotcrete (14.79 m³/disparo); 61.42 TM adicionales de desmonte por ciclo; destrucción de medias cañas (HCF = 11.20%)."))
    ...
    story.append(ph2("2.6. Termodinámica de la Detonación, Modelo ZND y Ecuación de Chapman-Jouguet"))
    ...
    story.append(p("En el plano C-J, donde la velocidad del flujo de los productos gaseosos relativa al frente de choque es exactamente sónica ($u + c = D_{vod}$), la presión de detonación ($P_t$) para la emulsión matriz de Lincuna (densidad $\\rho_e = 1.00\\text{ g/cm}^3 = 1,000\\text{ kg/m}^3$, velocidad de detonación nominal $VOD = 4,000\\text{ m/s}$) se calcula rigurosamente mediante:"))
    ...
    story.append(ph2("2.7. Formulación de la Ecuación de Estado JWL para Emulsiones Encartuchadas"))
