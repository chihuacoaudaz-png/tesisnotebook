# -*- coding: utf-8 -*-
"""
GENERADOR INTEGRAL MASIVO (GARANTIZA >= 33 PÁGINAS FÍSICAS EN MS WORD Y PDF)
"""
...
def generate_massive_full_plan(output_docx="output/PLAN_DE_TESIS_MARCO_TEORICO_30PAGS.docx"):
...
if __name__ == "__main__":
    docx_file = generate_massive_full_plan()
