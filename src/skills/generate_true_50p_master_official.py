# -*- coding: utf-8 -*-
"""
GENERADOR MODULAR MAESTRO DEL PLAN DE TESIS OFICIAL UNI FIGMM (META: >= 48-52 PÁGINAS FÍSICAS VERIFICADAS)
"""
...
def generate_master_document(docx_path="output/PLAN_DE_TESIS_OFICIAL_UNI_LINCUNA.docx"):
    ...
    # Importamos y ejecutamos la lógica probada
